...
<span class="hl">git branch</span> -v            <span class="cmt"># show commit each branch points to</span>`}},
  ...
  challenges:[
    ...
    {q:"What is the name of the special Git pointer that always tells you which branch (or commit) you are currently on?",scenario:"Your team lead asks: 'What pointer tracks your current location in the Git graph?'",hint:"It's a four-letter word written in ALL CAPS. It always shows your current position in the Git graph.",accept:["head","HEAD","the HEAD pointer","the head pointer","HEAD pointer"],feedback:"HEAD is a pointer to your current position. Normally it points to a branch name (which points to a commit). In detached HEAD state, it points directly to a commit hash."},
