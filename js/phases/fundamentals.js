...
phases.push(
{
  ...
  challenges:[
    {q:"In a distributed VCS like Git, what does every developer have on their local machine?",scenario:"You are comparing centralized VCS (like SVN) to distributed VCS (like Git). What is the key advantage?",hint:"Think about what 'distributed' means — every developer doesn't just have the latest files, they have the complete ______.",accept:["a full copy of the entire repository history","full copy of the repo","complete copy of the repository","the entire repository including all history","a complete copy of all history","full history of the repo","the full repo including history","a full copy of the repo","the complete repository","entire repo history","full copy of the entire repo","a complete copy of the repository","the whole repository and its history","every version of every file","the full repository"],keywords:["full|complete|entire","copy|clone|replica","history|repository|repo"],feedback:"In a distributed VCS, every developer has a complete copy of the entire repository including all its history. If Git is not installed, you get an error instead."},
